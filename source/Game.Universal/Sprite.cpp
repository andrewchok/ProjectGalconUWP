...
{
	Sprite::Sprite(uint32_t spriteIndex, const Transform2D& transform, const XMFLOAT4X4& textureTransform) :
		mSpriteIndex(spriteIndex), mTransform(transform), mTextureTransform(textureTransform)
	{
	}
